...
extension ActionHeaderView {
    ...
    fileprivate func customizeComponents() {
        ...
        themeManager.setDCBlueTheme(to: flossButton, ofType: .ButtonTabStyle(label: "dashboard_tab_brush".localized()))
        flossButton.addTarget(self, action: Selector.tabBarButtonPressed, for: .touchUpInside)
        
        themeManager.setDCBlueTheme(to: brushButton, ofType: .ButtonTabStyle(label: "dashboard_tab_floss".localized()))
